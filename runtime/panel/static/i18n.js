...
const LOCALES = {
    "zh-CN": {
        ...
        "tasks.replay": "准备 Replay",
        "tasks.prepared": "已准备新的 Run，请确认后启动",
        "tasks.paused": "已暂停",
        ...
        "settings_page.subtitle": "管理模型、接口、执行模式、访问权限、用户记忆和回退备份",
        ...
        "plugins_js.source_external_adapter": "外部适配器",
    ...
    "en": {
        ...
        "tasks.replay": "Prepare Replay",
        "tasks.prepared": "A new Run is prepared and awaits explicit start",
        "tasks.paused": "Paused",
        ...
        "settings_page.subtitle": "Manage models, providers, execution mode, access, memories and backups",
        ...
        "plugins_js.source_external_adapter": "External Adapter",
        "plugins_js.source_mcp": "MCP",
