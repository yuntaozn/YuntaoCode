...
const LOCALES = {
    "zh-CN": {
        ...
        "tasks.export_fixture": "导出技能样本",
        "tasks.fixture_exported": "技能样本 JSON 已导出，请分享前检查是否包含敏感信息",
    ...
    "en": {
        ...
        "tasks.export_fixture": "Export Skill Sample",
        "tasks.fixture_exported": "Skill sample JSON exported. Review it before sharing.",
