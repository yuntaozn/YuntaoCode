...
const LOCALES = {
    "zh-CN": {
        ...
        "composer.select_project_first": "先选择项目目录，再开始对话",
        ...
        "workspace.remove": "移除",
        "workspace.select_dir": "请选择项目目录",
        "workspace.opened": "已打开项目目录",
        "workspace.select_first": "请先选择或添加项目目录",
    ...
    "en": {
        ...
        "sidebar.select_folder": "Select",
        "sidebar.conversations": "Chats",
        "sidebar.search_history": "Search history",

        // === Topbar ===
        "topbar.select_project": "Select a project",
        ...
        "composer.select_project_first": "Select a project first",
        ...
        "workspace.select_dir": "Select a project directory",
        "workspace.opened": "Project directory opened",
        "workspace.select_first": "Please select or add a project directory first",
