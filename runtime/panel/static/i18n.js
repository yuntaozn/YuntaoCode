...
const LOCALES = {
    "zh-CN": {
        ...
        // === Plugins dialog (HTML) ===
        "plugins.title": "能力与插件",
        "plugins.desc": "当前展示内置能力、MCP 能力和 AI 自建插件草稿。",
        ...
        "plugins_page.subtitle": "查看内置能力、MCP 能力和 AI 自建插件草稿",
    ...
    "en": {
        ...
        "plugins.desc": "This page shows built-in capabilities, MCP capabilities, and AI-built plugin drafts.",
        ...
        "plugins_page.subtitle": "View built-in capabilities, MCP capabilities, and AI-built plugin drafts",
