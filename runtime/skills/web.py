...
def register_web_tools(registry: ToolRegistry) -> None:
    registry.register(
        ToolSpec(
            ...
            local_only=False,
            capability="web.http_read",
            artifacts=["http_response"],
            roles=["evidence"],
    ...
    registry.register(
        ToolSpec(
            ...
            capability="web.rendered_read",
            artifacts=["html", "text", "links"],
            roles=["evidence"],
            verification_strength="weak",
    ...
    registry.register(
        ToolSpec(
            ...
            effects=["artifact_write", "file_write", "local_state_change"],
